const beliefsData = [
  {
    ...
    subTitle1: 'Stary Testament',
    subTitle2: 'Nowy Testament',
    subContent1:
    ...
    reference: {
      ...
      referenceContent: [
        { contentTitle: 'Rdz', contetn: ['1:1'] },
        { contentTitle: 'Ps', contetn: ['19:2-5'] },
        { contentTitle: 'Prz', contetn: ['22:19-21'] },
        { contentTitle: 'Łk', contetn: ['24:27,44'] },
        { contentTitle: 'Rz', contetn: ['1:19-21', '2:14-15'] },
        { contentTitle: 'Ef', contetn: ['2:20'] },
        { contentTitle: '1 Tes', contetn: ['2:13'] },
        { contentTitle: '2 Tm', contetn: ['3:15-17'] },
        { contentTitle: 'Hbr', contetn: ['1:1-2'] },
        { contentTitle: '2-P', contetn: ['1:19-21'] },
        { contentTitle: '1-J', contetn: ['5:9'] },
      ],
    },
  },
  {
    ...
    reference: {
      referenceTitle: 'Referencje biblijne',
      referenceContent: [
        { contentTitle: 'Rdz', contetn: ['17:1'] },
        { contentTitle: 'Wj', contetn: ['3:14'] },
        { contentTitle: 'Pwt', contetn: ['4:15-16', '6:4-6'] },

        { contentTitle: '1-Krl', contetn: ['8:27'] },
        { contentTitle: 'Ps', contetn: ['90:2'] },
        { contentTitle: 'Iz', contetn: ['6:3', '46:9-10', '48,12'] },

        { contentTitle: 'Jr', contetn: ['10:10', '23:23-24'] },
        { contentTitle: 'Ml', contetn: ['3:6'] },
        { contentTitle: 'Mt', contetn: ['28:19'] },

        { contentTitle: 'J', contetn: ['1:1-9, 18', '4:24'] },
        { contentTitle: 'Rz', contetn: ['9:5', '11:35-36'] },
        { contentTitle: '1-Kor ', contetn: ['8:4-6'] },

        { contentTitle: '2-Kor', contetn: ['13:13'] },
        { contentTitle: '1-Tm', contetn: ['1:17'] },
        { contentTitle: 'Hbr', contetn: ['2:6'] },

        { contentTitle: '1-J', contetn: ['5:8'] },
    ...
    reference: {
      ...
      referenceContent: [
        ...
        { contentTitle: '2-Kor', contetn: ['13:13'] },
        { contentTitle: 'Ef', contetn: ['1:22-23'] },
        { contentTitle: 'Flp ', contetn: ['2:11'] },
